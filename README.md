...
Given a region in a map, our task is to predict the number of pickups in a 10 minute interval. Suppose we are at time t, we will use all the data till time (t-1) to predict the pickup at time t.
